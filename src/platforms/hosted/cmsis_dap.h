...
void dap_exit_function(void) { }
void dap_adiv5_dp_defaults(adiv5_debug_port_s *dp) { }
int cmsis_dap_jtagtap_init(jtag_proc_s *jtag_proc) { return -1; }
int dap_swdptap_init(adiv5_debug_port_s *dp) { return -1; }
int dap_jtag_dp_init(adiv5_debug_port_s *dp) { return -1; }
void dap_swd_configure(uint8_t cfg) { }
void dap_nrst_set_val(bool assert) { }
