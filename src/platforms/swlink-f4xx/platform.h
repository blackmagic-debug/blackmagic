...
#define BOARD_IDENT "Black Magic Probe (WeAct MiniF4x1), (Firmware " FIRMWARE_VERSION ")"
#define DFU_IDENT   "Black Magic Firmware Upgrade (WeAct MiniF4x1)"

/* Important pin mappings for STM32 implementation:
 *
 * LED0 = 	PD12	(Green  LED : Running) - Not here
 * LED1 = 	PD13	(Orange LED : Idle) - Not here
 * LED2 = 	PD12	(Red LED    : Error) - Not here
 * LED3 = 	PD15	(Blue LED   : Bootloader active) PC13
 *
 * nTRST = 	PA0
 * SRST_OUT =   PC8 - not here
 * TDI = 	PA3
