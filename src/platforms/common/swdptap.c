...
#define SWCLK_SET       gpio_set(SWCLK_PORT, SWCLK_PIN)
#define SWCLK_CLR       gpio_clear(SWCLK_PORT, SWCLK_PIN)
#define SWDAT_READ      gpio_get(SWDIO_PORT, SWDIO_PIN)
#define SWDAT_WRITE(x)  gpio_set_val(SWDIO_PORT, SWDIO_PIN, x)
