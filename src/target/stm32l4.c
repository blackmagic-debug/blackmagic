...
static bool stm32l4_mass_erase(target_s *t, platform_timeout_s *print_progess);
...
static bool stm32l4_flash_busy_wait(target_s *const t, platform_timeout_s *const print_progess)
{
...
static bool stm32l4_mass_erase(target_s *const t, platform_timeout_s *const print_progess)
{
	return stm32l4_cmd_erase(t, FLASH_CR_MER1 | FLASH_CR_MER2, print_progess);
}
