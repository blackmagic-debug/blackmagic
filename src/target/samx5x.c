...
#define SAMX5X_NVM_USER_PAGE   0x00804000U
#define SAMX5X_NVM_CALIBRATION 0x00800000U
#define SAMX5X_NVM_SERIAL(n)   (0x0080600CU + ((n) == 0 ? 0x1F0U : (n)*4U))
