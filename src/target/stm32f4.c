...
static bool stm32f4_mass_erase(target_s *t, platform_timeout_s *print_progess);
...
static bool stm32f4_mass_erase(target_s *const t, platform_timeout_s *const print_progess)
{
	/* XXX: Is it correct to grab the most recently added Flash region here? What is this really trying to do? */
	stm32f4_flash_s *stm32f4_flash = (stm32f4_flash_s *)t->flash;
	stm32f4_flash_unlock(t);
	...
	/* Wait for completion or an error */
	return stm32f4_flash_busy_wait(t, print_progess);
}
