...
#if CONFIG_BMDA == 0
static void remote_packet_process_adiv6(gdb_packet_s *packet);
...
static void remote_packet_process_adiv6(gdb_packet_s *const packet)
{
